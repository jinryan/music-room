...
export class DebugOverlay {
  ...
  render(
    ...
    const smoothed = featureFrame.features.hand.position
    ...
    const velocity = featureFrame.features.hand.velocity
    drawVelocityArrow(context, smoothX, smoothY, velocity, canvas)

    setHudValue(speedEl, featureFrame.features.hand.speed)
  }
...
function setHudValue(target: HTMLSpanElement, value: number | null) {
  target.textContent =
    value === null ? CONFIG.ui.hudEmpty : value.toFixed(2)
}
